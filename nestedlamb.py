                ...
                for s4 in l4:
                    for s5 in l5:
                        for s6 in l6:
                            for s7 in l7:
                                for s8 in l8:
                                    x = lambda  s1=s1, s2=s2, s3=s3, s4=s4, s5=s5, s6=s6, s7=s7, s8=s8: (s1,s2,s3,s4,s5,s6,s7,s8)
                                    funs.append(x)
    return funs
...
funlist = [lamlist(a,b,c,d,e,f,g,h), lamlist(i,j,k,l,m,n,o,p), lamlist(q,r,s,t,u,v,w,x), lamlist(y,z,a1,b1,c1,d1,e1,f1), lamlist(g1, h1, i1, j1, k1, l1, m1, n1), lamlist(o1, p1, q1, r1, s1, t1, u1, v1), lamlist(w1, x1, y1, z1, a2, b2, c2, d2), lamlist(e2,f2, g2, h2, i2, j2, k2, l2)]

for f1 in funlist[0]:
    g1, g2, g3, g4, g5,g6,g7,g8 = f1()
    for f2 in funlist[1]:
        h1, h2,h3, h4, h5,h6, h7,h8= f2()
        for f3 in funlist[2]:
